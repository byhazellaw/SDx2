...
public class PlagiarismDetector{
	...
	public static Map<String, Integer> detectPlagiarism(String dirName, int windowSize, int threshold) {
		...
		for (int i = 0; i < files.length; i++) {
			...
			for (int j = 0; j < files.length; j++) { 
				...
				//if (matches == null)								//redundant null check
					//return null;
	...
	protected static List<String> readFile(String filename) {
		...
		List<String> words = new ArrayList<String>();			//changed to Arraylist from linkedlist
	...
	//TODO replace Set with Arraylist for faster index performance
	...
	//changed input from Set to List
